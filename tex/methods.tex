...
To maximize viability, apoptosis and program flow instructions in randomly-generated seed genomes were replaced with nop instructions.
However, apoptosis and program flow instructions were allowed to mutate in freely from that point forward.
In addition, to counteract crowding of the mutational landscape by the volume of custom instructions provided, a second identical copy of each default SignalGP instruction was included in the library.
...
To conserve disk space, we divided evolutionary runs into 262144 ($2^{18}$) update epochs and collected data between epochs.
