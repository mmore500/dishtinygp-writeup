...
\vspace{0pt} % for alignment
\begin{subfigure}[b]{\textwidth}
\includegraphics[width=\textwidth]{knockout/intermessaging-intergroup_border/title=borderasymmetry+_data_hathash_hash=2f6d7b6c94c68145+_script_fullcat_hash=72ddde2468c1d0b0+_source_hash=53a2252-clean+ext=}%
\caption{Asymmetric group relations}
\label{fig:intermessaging-intergroup_border-borderasymmetry}
\end{subfigure}
\end{minipage}%
\hspace*{\fill}
...
Subfigures \ref{fig:intermessaging-intergroup_border-sharing}, \ref{fig:intermessaging-intergroup_border-cellage}, \ref{fig:intermessaging-intergroup_border-pparentage}, \ref{fig:intermessaging-intergroup_border-borderage}, and \ref{fig:intermessaging-intergroup_border-borderasymmetry} quantify knockout effects on various phenotypic traits.
