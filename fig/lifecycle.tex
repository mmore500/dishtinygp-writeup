...
In subfigures \ref{fig:lifecycle-coalesce}, \ref{fig:lifecycle-sweep}, and \ref{fig:lifecycle-burst}, red annotations denote a propagule-parent relationship and yellow annotations a propagule-child relationship.
In subfigure \ref{fig:lifecycle-naive}, magenta annotations denote a cellular-parent relationship and blue annotations a cellular-child relationship.
}
\label{fig:lifecycle}
\end{center}
\end{figure*}
