...
\caption{Wild type}
\label{fig:stockpiletrigger-sharing-wt}
\end{subfigure}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.45\columnwidth}
...
\label{fig:stockpiletrigger-sharing-ko}
\end{subfigure}
\end{minipage}%
\hspace*{\fill}

\caption{
Comparison of a wild type strain evolved under the ``Nested-Wave'' treatment and corresponding resource-sensing knockout strain.
